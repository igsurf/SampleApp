        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/igsurf/sampleapp/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/igsurf/sampleapp.git")
                        developerConnection.set("scm:git:ssh://github.com/igsurf/sampleapp.git")
                        url.set("https://github.com/igsurf/sampleapp/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/igsurf/sampleapp/issues")
                    }
                }
            }
        }
